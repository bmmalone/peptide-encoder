...
project = 'peptide_encoder'
copyright = '2022, Brandon Malone'
author = 'Brandon'
...
###
base_filename = 'peptide_encoder'
short_description=  'Documentation for peptide_encoder'
...
htmlhelp_basename = 'peptide_encoder_doc'
